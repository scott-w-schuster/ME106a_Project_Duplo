...
class IKPlanner(Node):
    ...
    def plan_to_joints(self, target_joint_state, speed=1.0):
        ...
        req.motion_plan_request.max_velocity_scaling_factor = speed
        req.motion_plan_request.max_acceleration_scaling_factor = speed
